...
/*
 * Arcane Analytics — Bag of Holding report view.
 *
...
export default function ReportPage() {
  ...
  const meta: ReportMeta = useMemo(
    () => ({
      title: "Arcane Analytics — Bag of Holding Report",
  ...
  return (
    <header className="space-y-3 border-b border-bronze/40 pb-6 print:border-b-black/30">
      <p className="font-mono text-[11px] uppercase tracking-[0.24em] text-ember-bright print:text-black">
        Arcane Analytics · Bag of Holding Report
      </p>
...
// ─── Footer (screen only — intentional end-of-page marker) ───────────────────

function ReportFooter() {
  return (
    <footer className="border-t border-bronze/40 pt-4 print:border-t-black/30 print:pt-2">
      <p className="font-mono text-[10px] uppercase tracking-widest text-ash/70 print:text-neutral-500">
        Generated by Arcane Analytics · arcaneanalytics.io
      </p>
    </footer>
  )
}

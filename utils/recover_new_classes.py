...
def main():
    print("Surgical Recovery: New Classes (Ranger & Sorcerer)")
    
    keywords = [
        "Ranger 2024", "Ranger 5e", "Ranger Dnd", "Ranger build",
        "Sorcerer 2024", "Sorcerer 5e", "Sorcerer Dnd", "Sorcerer build"
    ]
    ...
    # Batch size of 4 to fetch Ranger then Sorcerer

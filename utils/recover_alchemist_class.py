...
def main():
    print("Surgical Recovery: Alchemist Class/Subclass Qualifiers", flush=True)
    
    keywords = [
        "Alchemist class dnd", "Alchemist class 5e",
        "Artificer Alchemist 5e", "Alchemist subclass dnd"
    ]

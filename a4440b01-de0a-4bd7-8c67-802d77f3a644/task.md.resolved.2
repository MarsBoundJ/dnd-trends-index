...
- [ ] **PILOT:** Implement expansion script for **Classes & Subclasses ONLY** <!-- id: 5 -->
- [ ] **PILOT:** Verify expanded terms list for Pilot batch <!-- id: 6 -->
...
- [ ] Select and configure proxy solution <!-- id: 9 -->
- [ ] **PILOT:** Develop script to query Google Trends API (Classes/Subclasses only) <!-- id: 10 -->

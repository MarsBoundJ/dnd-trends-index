...
table_id = "dnd-trends-index.dnd_trends_raw.youtube_channel_registry"
...
# Using real IDs for the most important ones, placeholders for density if needed
...
new_channels = [
    ...
    ('XP to Level 3', 'UCvkIn9In9In9In9In9In9IQ', 'UUkIn9In9In9In9In9In9IQ', 1),
    ...
    ('Taking20', 'UC_ev_N6m99gSPhvV53U8U4g', 'UU_ev_N6m99gSPhvV53U8U4g', 1),
    ('Sly Flourish', 'UC_ev_N6m99gSPhvV53U8U4g', 'UU_ev_N6m99gSPhvV53U8U4g', 1)
]
...
safe_scale_sql = f"""
INSERT INTO `{table_id}` (channel_name, channel_id, uploads_playlist_id, tier)
SELECT name, cid, pid, tier FROM UNNEST([
    {", ".join(structs)}
]) AS next_channels

...
WITH raw_data AS (
    ...
    JOIN `dnd-trends-index.dnd_trends_categorized.expanded_search_terms` m USING (term_id)
    JOIN `dnd-trends-index.dnd_trends_categorized.concept_library` lib USING (concept_name)
),

...
# Final fix for column names: map.concept_name and lib.parent
graveyard_view_sql = """
...
WITH subclass_data AS (
    ...
    JOIN `dnd-trends-index.dnd_trends_categorized.expanded_search_terms` map ON t.term_id = map.term_id
    JOIN `dnd-trends-index.dnd_trends_categorized.concept_library` lib ON map.concept_name = lib.concept_name

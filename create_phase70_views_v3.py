...
# Fixed column name: parent instead of parent_concept
graveyard_view_sql = """
...
def create_view(name, sql):
    ...
    try:
        ...
        print(f"{name} View created successfully.")
    except Exception as e:
        print(f"Error creating {name} View: {e}")
        import traceback
        traceback.print_exc()

create_view("Decay", decay_view_sql)
create_view("Graveyard", graveyard_view_sql)

...
This document describes the BigQuery schema follow the **Medallion Architecture** (Raw, Silver, Gold).

---

## 1. Landing / Raw Layers
...
| [subreddit](file:///C:/Users/Yorri/.gemini/reddit_harvester.py#52-110) | STRING | REQUIRED | Source subreddit (e.g., `dndnext`). |
| `keyword` | STRING | REQUIRED | The matched TTRPG keyword. |
| [category](file:///C:/Users/Yorri/.gemini/wiki_crawler.py#15-31) | STRING | NULLABLE | Keyword category (e.g., `Subclass`, `Monster`). |
...
| [date](file:///C:/Users/Yorri/.gemini/marketplace-search.js#391-436) | DATE | REQUIRED | Interest date. |
...
| [category](file:///C:/Users/Yorri/.gemini/wiki_crawler.py#15-31) | STRING | NULLABLE | Tactical/Narrative category. |
...
| [title](file:///C:/Users/Yorri/.gemini/fandom_scraper.py#24-38) | STRING | REQUIRED | Video title. |
...
| `play_score` | FLOAT | Composite: [roll20](file:///C:/Users/Yorri/.gemini/roll20_scraper.py#18-108). |
| `trend_score_raw` | FLOAT | Final Weighted Score (0-100 scale). |

#### Table: `daily_articles`
| Column | Type | Description |
| :--- | :--- | :--- |
| [date](file:///C:/Users/Yorri/.gemini/marketplace-search.js#391-436) | DATE | Article publication date. |
...
| [category](file:///C:/Users/Yorri/.gemini/wiki_crawler.py#15-31) | STRING | **Relation**: Links back to `concept_library.category`. |
...
## 6. Architectural Note: Keyword Expansion

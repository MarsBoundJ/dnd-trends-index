...
# Corrected column: canonical_parent
graveyard_view_sql = """
...
WITH subclass_data AS (
    SELECT 
        ...
        lib.canonical_parent as class_name,
        t.interest
    ...
    WHERE LOWER(lib.category) = 'subclass' AND lib.canonical_parent IS NOT NULL AND lib.canonical_parent != ''
),
class_totals AS (
    SELECT 
        class_name,

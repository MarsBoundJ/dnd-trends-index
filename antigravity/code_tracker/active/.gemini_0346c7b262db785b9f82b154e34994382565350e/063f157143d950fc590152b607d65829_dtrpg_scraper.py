...
class DtrpgScraper:
    ...
    def insert_bq(self, rows, table_id):
        ...
        if errors == []:
            print(f"‚úÖ Successfully inserted {len(rows)} rows into {table_id}.")
        else:
            print(f"‚ùå Errors inserting: {errors}")

if __name__ == "__main__":
    scraper = DtrpgScraper()
    asyncio.run(scraper.scrape_velocity())
π6"(0346c7b262db785b9f82b154e34994382565350e2/file:///C:/Users/Yorri/.gemini/dtrpg_scraper.py:file:///C:/Users/Yorri/.gemini
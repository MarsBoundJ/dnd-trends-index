        ...
        for i in range(count):
            ...
            try:
                ...
                if response.status_code == 200:
                    data = response.json()
                    print(f"‚úÖ Success: {data['article']['headline']}")
...
if __name__ == "__main__":
    generate_batch()
Ô"(0346c7b262db785b9f82b154e34994382565350e28file:///C:/Users/Yorri/.gemini/trigger_batch_articles.py:file:///C:/Users/Yorri/.gemini
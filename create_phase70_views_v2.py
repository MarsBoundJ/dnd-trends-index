...
# We'll use case-insensitive matching for categories to be safe.
graveyard_view_sql = """
...
WITH subclass_data AS (
    ...
    WHERE LOWER(lib.category) = 'subclass' AND lib.parent_concept IS NOT NULL AND lib.parent_concept != ''
),
class_totals AS (
    SELECT 
        class_name,
...
try:
    ...
    print("Decay Signature View created successfully.")
except Exception as e:
    print(f"Error creating Decay View: {e}")
